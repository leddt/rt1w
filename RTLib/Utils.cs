...
public static class Utils
{
    ...
    public static IHittable RotateX(this IHittable hittable, double angle) => new RotateX(hittable, angle);
    public static IHittable RotateY(this IHittable hittable, double angle) => new RotateY(hittable, angle);
    public static IHittable RotateZ(this IHittable hittable, double angle) => new RotateZ(hittable, angle);
